...
var ruStrings = map[string]string{
	...
	"What is this token?":                                 "Что это за токен?",
	"Recommended: Mattermost Personal Access Token.":      "Рекомендуется: Mattermost Personal Access Token.",
	"Also works: browser MMAUTHTOKEN session cookie.":     "Также работает: браузерная session cookie MMAUTHTOKEN.",
	"Use mmux auth to save MMAUTHTOKEN interactively.":    "Используйте mmux auth, чтобы интерактивно сохранить MMAUTHTOKEN.",
	...
	"attachment failed":                              "файл не прикреплён",
	"sent":                                           "отправлено",
