...
var ruStrings = map[string]string{
	...
	"How to get a token:":                                        "Как получить токен:",
	"Mattermost profile → Security → Personal Access Tokens.":    "Mattermost: профиль → безопасность → Personal Access Tokens.",
	"Or run mmux auth and paste the browser MMAUTHTOKEN cookie.": "Или запустите mmux auth и вставьте cookie MMAUTHTOKEN из браузера.",
