...
MMUX_VERSION=v0.1.9 curl -fsSL https://raw.githubusercontent.com/iRootPro/mmux/main/scripts/install.sh | sh
...
curl -L -o mmux.tar.gz \
  https://github.com/iRootPro/mmux/releases/download/v0.1.9/mmux_v0.1.9_linux_amd64.tar.gz

# arm64 / aarch64
# curl -L -o mmux.tar.gz \
#   https://github.com/iRootPro/mmux/releases/download/v0.1.9/mmux_v0.1.9_linux_arm64.tar.gz

tar -xzf mmux.tar.gz
sudo install -m 0755 mmux_v0.1.9_linux_amd64/mmux /usr/local/bin/mmux
```
