...
- timeline focus: `j/k` select message, `y` copy text, `p` copy permalink, `o` open first link, `r` quote into composer, `e` edit own message, `D` delete own message (press twice), `t` open thread
